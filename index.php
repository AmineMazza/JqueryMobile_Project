...
<body>
    ...
    <div data-role="page" id="page1">
        ...
        <div data-role="header" style="background-color: cornflowerblue; color: white;">
            ...
            <div data-role="navbar">
                <ul>
                    ...
                    <li><a href="#" class="ui-btn ui-icon-carat-d ui-btn-a ui-btn-icon-left ui-btn-corner-all">Places
                            Populaires</a></li>
        ...
        <div data-role="panel" id="panel">
            ...
            <a href="#" class="ui-btn ui-icon-home ui-btn-active ui-btn-icon-left ui-btn-corner-all">Hôtels</a><br>
            <a href="#" class="ui-btn ui-icon-home ui-btn-active ui-btn-icon-left ui-btn-corner-all">Restaurants</a><br>
            <a href="#" class="ui-btn ui-icon-location ui-btn-active ui-btn-icon-left ui-btn-corner-all">Monuments Historiques</a><br>
</div>
    ...
    <div data-role="page" id="page3" data-dialog="true">
        ...
        <div data-role="main" class="ui-content">
            <ul>
                <p><a href=""> Marrakech</a> </p>
                <p><a href=""> Casablanca</a> </p>
                <p><a href=""> Agadir</a> </p>
                <p><a href=""> Tanger</a> </p>
                <p><a href=""> Tetouane</a> </p>
            </ul>
    ...
    <div data-role="page" id="page5" data-dialog="true">
        ...
        <div data-role="main" class="ui-content">
            ...
            <div>
                <h1>Marrakech</h1>
                <img src="img\marrakech.jpg" alt="" style="height: 250px; width: 320px;"><br>
                <fieldset data-role="controlgroup">
                    <legend>Votre proposition :</legend>
                    <input type="radio" name="radio-choice-1" id="radio-choice-1" value="choice-1" checked="checked">
                    <label for="radio-choice-1">Je veux</label>
                    
                    <input type="radio" name="radio-choice-2" id="radio-choice-2" value="choice-2">
                    <label for="radio-choice-2">Je veux pas</label>
